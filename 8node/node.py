...
CURRENT_NODE = 'Node 1'
CURRENT_NODE_PORT = 5000  # Port should be an integer
...
def fetch_next_node(source_node, target_node):
    ...
    # Error if the source or target node is not found
    ...
    # If source and target are the same, there's no next node to forward to
    ...
    while queue:
        ...
        if current_node == target_node:
            # We found the target node, return the node that led to it
